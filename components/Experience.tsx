    ...
    <section id="experience" className="py-24 bg-primary">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-20">
          <h2 className="font-heading text-4xl md:text-5xl font-bold text-secondary mb-4 text-white">Experience & Education</h2>
          <p className="text-white">Professional journey and academic achievements in Corporate Communications.</p>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16">
          ...
          <div >
            <div className="flex items-center mb-10">
              <div className="p-3 bg-pink/10 rounded-xl mr-4">
                <Briefcase className="text-pink h-6 w-6" />
              </div>
              <h3 className="font-heading text-2xl font-bold text-pink">Work Experience</h3>
            </div>
            ...
            <div className="space-y-12 border-l border-gray-300 ml-4 pl-8 relative">
              {EXPERIENCE.map((job) => (
                <div key={job.id} className="relative group">
                  ...
                  <div className="mb-2">
                    <h4 className="text-xl font-bold text-pink transition-colors">{job.role}</h4>
                  ...
                  <ul className="mt-4 space-y-2">
                    {job.description.map((desc, i) => (
                      <li key={i} className="text-white/80 text-sm leading-relaxed relative pl-4">
          ...
          <div>
            <div className="flex items-center mb-10">
              ...
              <h3 className="font-heading text-2xl font-bold text-pink">Education</h3>
            </div>
            ...
            <div className="space-y-12 border-l border-gray-300 ml-4 pl-8 relative">
              {EDUCATION.map((edu) => (
                <div key={edu.id} className="relative group">
                  ...
                  <h4 className="text-xl font-bold text-pink">{edu.degree}</h4>
                  ...
                  {edu.details && <p className="text-white/80 text-sm">{edu.details}</p>}
                </div>
              ))}
            </div>
          </div>
